...
yes = ["yes", "yep", "fine", "okay", "okey", "ok", "affirmative", "yeah", "absolutely", "agreed", "all right", "alright", "assuredly", "aye", "beyond a doubt", "by all means", "certainly", "definitely", "gladly", "indubitably", "assuredly", "naturally", "of course", "ofcourse", "positively", "precisely", "sure", "surely", "undoubtedly", "unquestionably", "very well", "willingly"]
...
participation_again = ["Would you like to review another movie?","Would you like to give it another try?","Would you like me to predict another review?","This is fun! Want to go again?","Would you like to try it again?"]
participation_confused = ["Please be clearer."]
affirmative = ["Cool!","Nice!","Let's go!","Here we go!","I'm ready!"]
goodbye = ["Well, if you change your mind, I'm right here...","Another time then!","OK cool, see you later then!","Alright, another time then.","OK, I understand. Another time, friend!"]
...
yesno = participation_analysis(input(random.choice(participation_request) + "\n"))
prompt_review = True
while prompt_review:
    if yesno[0] == False and yesno[1] == False:
        yesno = participation_analysis(input(random.choice(participation_confused) + "\n"))
        ...
        yesno = participation_analysis(input(random.choice(participation_again) + "\n"))
    else:
        prompt_review = False
